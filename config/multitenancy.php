...
return [
    /*
     * Determines which tenant should be current for the given request.
     * DomainTenantFinder: identifies tenants by subdomain (e.g. oneautos.planesahorro.com)
     */
     ...
     */
    'tenant_database_connection_name' => 'mariadb',
